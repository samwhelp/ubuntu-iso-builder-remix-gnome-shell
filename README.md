...
| `+` | `+` |
| [ubuntu-iso-builder-remix-gnome-shell](https://samwhelp.github.io/ubuntu-iso-builder-remix-gnome-shell/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-gnome-shell](https://samwhelp.github.io/ubuntu-iso-builder-respin-gnome-shell/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-gnome-shell) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-gnome-shell](https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-gnome-shell.git
```


> change dir to `ubuntu-iso-builder-remix-gnome-shell`

``` sh
cd ubuntu-iso-builder-remix-gnome-shell
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-gnome-shell/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-gnome-shell/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-gnome-shell/iso-profile/dist`
